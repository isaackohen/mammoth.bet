...
class User extends \Jenssegers\Mongodb\Auth\User implements JWTSubject {
    ...
    protected $fillable = [
        ...
        'wallet_trx_private_key', 'freegames', 'freegames_balance', 'referral_balance_usd', 'bonus1', 'bonus1_goal', 'bonus1_currency', 'bonus1_wager', 'bonus2', 'bonus2_goal', 'bonus2_currency', 'bonus2_wager', 'wallet_xBLZD', 'xBLZD', 'demo_xBLZD'
    ];
    ...
    protected $hidden = [
        ...
        'demo_btc', 'demo_ltc', 'demo_eth', 'demo_doge', 'demo_bch', 'demo_trx', 'demo_xrp', 'demo_usdt', 'demo_usdc', 'demo_bnb', 'demo_bonus',
        'wallet_btc', 'wallet_ltc', 'wallet_eth', 'wallet_doge', 'wallet_bch', 'wallet_trx', 'wallet_xrp', 'wallet_usdt', 'wallet_usdc', 'wallet_bnb', 'wallet_bonus',
        'wallet_trx_private_key', 'bonus1', 'bonus1_wager', 'bonus1_currency', 'bonus1_wager', 'bonus2', 'bonus2_goal', 'bonus2_currency', 'bonus2_wager', 'wallet_xBLZD', 'xBLZD', 'demo_xBLZD'
    ];
