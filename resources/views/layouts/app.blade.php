...
<html lang="en" class="theme--{{ $_COOKIE['theme'] ?? 'dark' }}">
    <head>
        ...
        <script src="https://kit.fontawesome.com/933c008fcc.js" crossorigin="anonymous"></script>
        ...
        'xBLZD' => ['dollar' => \App\Http\Controllers\Api\WalletController::rateDollarxBLZD(), 'euro' => \App\Http\Controllers\Api\WalletController::rateDollarxBLZDEur()],
    ...
    <div class="wrapper">
        <header>
            <div class="fixed">
                ...
                <a onclick="redirect('/')"><div class="logo" style="width: 43px !important;"></div></a>
                @if(!auth()->guest())
                <div class="wallet">
                    <div class="wallet-switcher">
                       ...
                       @endif
                        ...
                        <div class="option select-option">
                            <div class="wallet-switcher-icon">
                               <img src="/img/currency/svg/usd.svg" style="width: 14px; height: 14px;">
                            </div>
                            <div class="wallet-switcher-content">
                                {{ __('general.unit') }}:
                    ...
                    <div class="btn btn-secondary icon">
                        <img class="" data-selected-currency width="14px" height="14px">
                ...
                <footer class="text-center text-white">
                    <div class="container p-4">
                        ...
                        <div class="footer-bottom text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
                            <img src="/img/logo/logo.png" alt="{{ \App\Settings::where('name', 'platform_name')->first()->value }} Logo">
                        </div>
                    </footer>
                </div>
                <div class="chat">
